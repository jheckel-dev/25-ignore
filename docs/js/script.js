...
function displayNews (year, month, day){
  ...
  var request_url="https://en.wikipedia.org/api/rest_v1/feed/featured/" + year +"/" + month + "/" +day ;
   ...
   .catch(err => {
      mostReadEl.innerHTML= "<span style='color:gold; font-weight: bold;'>No data available: </span>" +
      "<span style='padding:30px 0px'>This feature was released in 2016</span>";
      console.error(err);
   });
...
function displayNewsDay (year, month, day){
  ...
  var request_url="https://en.wikipedia.org/api/rest_v1/feed/featured/" + year +"/" + month + "/" +day ;
   ...
   .catch(err => {
      newsOnDay.innerHTML="<span style='color:gold; font-weight: bold;'>No data available: </span>" +
      "<span style='padding:30px 0px'>This feature was released in 2000</span>";
      console.error(err);
   });
